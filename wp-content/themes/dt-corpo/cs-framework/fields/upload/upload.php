...
class CSFramework_Option_upload extends CSFramework_Options {
  ...
  public function output() {
    ...
    $button_title = ( isset( $button_title ) ) ? $button_title : esc_html__( 'Upload', 'dt-corpo' );
    $frame_title  = ( isset( $frame_title  ) ) ? $frame_title  : esc_html__( 'Upload', 'dt-corpo' );
    $insert_title = ( isset( $insert_title ) ) ? $insert_title : esc_html__( 'Use Image', 'dt-corpo' );
