...
// Map this shortcode
vc_map(array(
	'name'			=> esc_html__( 'Icon Box (Style 1)', 'corpo-ess'),
	'base'			=> 'corpo_icon_box_1',
	...
	'params'		=> array(
		...
		array(
			...
			'value'		=> array(
				__( 'Left Icon', 'corpo-ess' ) => 'left_icon',
				__( 'Right Icon', 'corpo-ess' ) => 'right_align',
				__( 'Top Centered Icon', 'corpo-ess' ) => 'top_center',
			),
			'param_name'	=> 'style',
			'description'	=> esc_html__( 'Select the box style.', 'corpo-ess' ),
		),
		...
		array(
			'param_name'	=> 'extra_margin',
			'type'			=> 'checkbox',
			'heading'		=> esc_html__( 'Extra margin', 'corpo-ess' ),
		),
...
class WPBakeryShortCode_corpo_icon_box_1 extends WPBakeryShortCode {}
